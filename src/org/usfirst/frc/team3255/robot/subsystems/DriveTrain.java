...
public class DriveTrain extends PIDSubsystem {
	...
	// Motor Controls
	CANTalon frontLeftTalon = null;
	CANTalon backLeftTalon = null;
	CANTalon frontRightTalon = null;
	CANTalon backRightTalon = null;
	...
	private static final double MAX_PID_SPEED = 0.6;
	...
	public void init() {
		frontLeftTalon = new CANTalon(RobotMap.DRIVETRAIN_FRONT_LEFT_CANTALON);
		backLeftTalon = new CANTalon(RobotMap.DRIVETRAIN_BACK_LEFT_CANTALON);
		frontRightTalon = new CANTalon(RobotMap.DRIVETRAIN_FRONT_RIGHT_CANTALON);
		backRightTalon = new CANTalon(RobotMap.DRIVETRAIN_BACK_RIGHT_CANTALON);
